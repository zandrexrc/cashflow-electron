...
const AccountForm = ({ currency, next }: IProps) => {
  ...
  const setName = (name: string) => setAccountState({ ...accountState, name });

  const setType = (type: string) => setAccountState({ ...accountState, type });
    ...
    <div className={classes.root}>
      <div className="description">
        ...
        <Typography variant="body2" color="textSecondary">
          ...
          You can create more later, but you need at least one to get started.
        </Typography>
      </div>
